...
//Firebase
import { collection, getDoc, doc, deleteDoc, query, where, onSnapshot } from 'firebase/firestore';
...
export default function UserPage() {
  ...
  useEffect(() => {
    const getData = async () => {
      ...
      collectionRef = query(collectionRef, where('role', '==', 'customer'));
